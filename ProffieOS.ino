...
#define CONFIG_FILE "config/TheOwlHootHoot_ScrollConfig.h"
...
// BladeBase. These classes know how many LEDs the currentx`x``
...
#ifndef PROP_TYPE
#include "props/saber_theowlhoothoot.h"
